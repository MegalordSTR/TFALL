...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the current position of a touch in m_window coordinates
    ///
    /// This function returns the current touch position
    /// relative to the given m_window.
    ///
    /// \param finger Finger index
...
/// happen when your m_window is out of focus and no event is triggered.
///
...
/// operates in m_window coordinates (relative to a specific m_window).
///
...
///
/// // get position of touch 1 relative to a m_window
/// sf::Vector2i relativePos = sf::Touch::getPosition(1, m_window);
/// \endcode
///
