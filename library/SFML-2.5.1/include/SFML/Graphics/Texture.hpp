...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief update the texture from the contents of a m_window
    ///
    /// Although the source m_window can be smaller than the texture,
    /// this function is usually used for updating the whole texture.
    /// The other overload, which has (x, y) additional arguments,
    /// is more convenient for updating a sub-area of the texture.
    ///
    /// No additional check is performed on the size of the m_window,
    /// passing a m_window bigger than the texture will lead to an
    /// undefined behavior.
    ///
    /// This function does nothing if either the texture or the m_window
    ...
    ////////////////////////////////////////////////////////////
    /// \brief update a part of the texture from the contents of a m_window
    ///
    /// No additional check is performed on the size of the m_window,
    /// passing an invalid combination of m_window size and offset
    /// will lead to an undefined behavior.
    ///
    /// This function does nothing if either the texture or the m_window
    /// was not previously created.
    ///
    /// \param window Window to copy to the texture
    /// \param x      X offset in the texture where to copy the source m_window
    /// \param y      Y offset in the texture where to copy the source m_window
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// framebuffer. This can be requested during m_window creation.
    ///
