...
# -----
#
# When you try to locate the SFML libraries, you must specify which modules you want to use (system, m_window, graphics, network, audio, main).
# If none is given, no imported target will be created and you won't be able to link to SFML libraries.
# example:
#   find_package(SFML COMPONENTS graphics m_window system) # find the graphics, m_window and system modules
#
...
# - For each specified module XXX (system, m_window, graphics, network, audio, main):
...
# against sfml-graphics will also automatically link against sfml-m_window and sfml-system.
#
# example:
...
# update requested components (eg. request m_window component if graphics component was requested)
